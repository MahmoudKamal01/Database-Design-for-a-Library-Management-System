...
"""
db = cx_Oracle.connect(user="hr", password="hr",dsn="localhost:1521/xe",encoding="UTF-8")
if db:
    print(1)
"""
...
def SetTables():
    ...
    #db.execute("CREATE TABLE events(event_id INTEGER ,event_name TEXT,author_id INTEGER,ticket_id INTEGER,event_date TEXT,PRIMARY KEY(event_id),FOREIGN KEY(author_id) REFERENCES author(author_id),FOREIGN KEY(ticket_id) REFERENCES tickets(ticket_id))")
